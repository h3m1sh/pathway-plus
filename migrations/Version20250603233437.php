 ...
 */
final class Version20250603233437 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE student_progress (id INT AUTO_INCREMENT NOT NULL, student_id INT DEFAULT NULL, micro_credential_id INT DEFAULT NULL, date_earned DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', status VARCHAR(255) DEFAULT NULL, verified_by VARCHAR(255) DEFAULT NULL, note LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', INDEX IDX_918ABEDDCB944F1A (student_id), INDEX IDX_918ABEDDACDB9113 (micro_credential_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
